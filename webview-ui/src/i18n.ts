...
const dict = {
  ...
  "insp.pin": { uz: "Status-barga qadash", ru: "Закрепить в статус-баре", en: "Pin to status bar" },
  "insp.unpin": { uz: "Status-bardan yechish", ru: "Открепить", en: "Unpin from status bar" },
  "insp.pinTip": { uz: "Panel yopiq bo'lsa ham shu agent va xarajati status-barda ko'rinadi", ru: "Агент и его затраты будут видны в статус-баре даже при закрытой панели", en: "Keep this agent and its cost in the status bar even when the panel is closed" },
  ...
  "dash.forecast": { uz: "Prognoz", ru: "Прогноз", en: "Forecast" },
  "dash.perHour": { uz: "soat", ru: "час", en: "hr" },
  "dash.toBudget": { uz: "budjetga", ru: "до бюджета", en: "to budget" },
  "dash.budgetOver": { uz: "budjet oshib ketdi", ru: "бюджет превышен", en: "over budget" },
  "dash.efficiency": { uz: "Samaradorlik", ru: "Эффективность", en: "Efficiency" },
  "dash.perTool": { uz: "Bir tool chaqiruviga o'rtacha xarajat", ru: "Средняя стоимость на вызов инструмента", en: "Average cost per tool call" },
  "dash.perTurn": { uz: "Bir navbatga o'rtacha token", ru: "Среднее число токенов на ход", en: "Average tokens per turn" },
  "dash.activeShare": { uz: "Faol ulush", ru: "Доля активности", en: "Active share" },
  "dash.toolShort": { uz: "tool", ru: "инстр", en: "tool" },
  "dash.turnShort": { uz: "navbat", ru: "ход", en: "turn" },
  "dash.byRole": { uz: "Rol bo'yicha xarajat", ru: "Затраты по ролям", en: "Cost by role" },
  "dash.agentsTable": { uz: "Agentlar", ru: "Агенты", en: "Agents" },
  "dash.sortBy": { uz: "Saralash uchun bosing", ru: "Нажмите для сортировки", en: "Click to sort" },
  "hist.open": { uz: "Tarix — kunlik trend, kecha vs bugun", ru: "История — тренд по дням, вчера/сегодня", en: "History — daily trend, yesterday vs today" },
  "hist.btn": { uz: "Tarix", ru: "История", en: "History" },
  "hist.title": { uz: "Tarix", ru: "История", en: "History" },
  "hist.hint": { uz: "Vaqt bo'yicha jamlanma — lokal saqlanadi (~/.agent-office)", ru: "Сводка по времени — хранится локально (~/.agent-office)", en: "Totals over time — stored locally (~/.agent-office)" },
  "hist.today": { uz: "Bugun", ru: "Сегодня", en: "Today" },
  "hist.yesterday": { uz: "Kecha", ru: "Вчера", en: "Yesterday" },
  "hist.vsYesterday": { uz: "kechaga nisbatan", ru: "к вчера", en: "vs yesterday" },
  "hist.trend": { uz: "Xarajat trendi", ru: "Тренд затрат", en: "Cost trend" },
  "hist.gran.day": { uz: "Kun", ru: "День", en: "Day" },
  "hist.gran.week": { uz: "Hafta", ru: "Неделя", en: "Week" },
  "hist.gran.month": { uz: "Oy", ru: "Месяц", en: "Month" },
  ...
  "filter.idle": { uz: "Bo'sh", ru: "Простой", en: "Idle" },
  "filter.none": { uz: "Bu filtrga mos agent yo'q", ru: "Нет агентов по фильтру", en: "No agents match this filter" },
