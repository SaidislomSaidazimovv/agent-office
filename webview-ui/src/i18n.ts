...
const dict = {
  ...
  "settings.textMode": { uz: "Matn rejimi", ru: "Текстовый режим", en: "Text mode" },
  "settings.textModeHint": { uz: "3D o'rniga klaviatura bilan yuriladigan ro'yxat (ekran o'quvchi uchun).", ru: "Вместо 3D — список с навигацией с клавиатуры (для скринридеров).", en: "A keyboard-navigable list instead of the 3D scene (for screen readers)." },
  "text.title": { uz: "Agentlar — matn rejimi", ru: "Агенты — текстовый режим", en: "Agents — text mode" },
  "text.hint": { uz: "↑↓ yoki Tab bilan yuring · Enter — tanlash. 3D sahna chizilmaydi.", ru: "Навигация ↑↓ или Tab · Enter — выбрать. 3D-сцена не отрисовывается.", en: "Move with ↑↓ or Tab · Enter to select. The 3D scene is not rendered." },
  "text.toggle": { uz: "Matn rejimi (a11y)", ru: "Текстовый режим (a11y)", en: "Text mode (a11y)" },
  ...
  "insp.contextHot": { uz: "Kontekst {n}% to'ldi — /compact bilan qisqartiring", ru: "Контекст {n}% — сожмите через /compact", en: "Context {n}% full — consider /compact" },
  ...
  "origin.external": { uz: "avto-topilgan", ru: "авто-найден", en: "auto-discovered" },
  "origin.internal": { uz: "ofisdan ochilgan", ru: "открыт из офиса", en: "launched here" },
  "origin.externalTip": { uz: "Bu sessiyani ofis o'zi topdi (siz +Agent bilan ochmagansiz).", ru: "Эта сессия найдена автоматически (не открыта через +Агент).", en: "This session was auto-discovered (not launched via +Agent)." },
  "origin.internalTip": { uz: "Bu agent +Agent tugmasi orqali shu ofisdan ochilgan.", ru: "Этот агент открыт из офиса через +Агент.", en: "This agent was launched from the office via +Agent." },
  ...
  "insight.contextHot": { uz: "«{name}» kontekst {n}% — /compact bilan qisqartiring", ru: "«{name}» контекст {n}% — сожмите через /compact", en: "«{name}» context {n}% — consider /compact" },
  ...
  // Sessiya hikoyasi
  "story.open": { uz: "Sessiya hikoyasi", ru: "История сессии", en: "Session story" },
  "story.btn": { uz: "Hikoya", ru: "История", en: "Story" },
  "story.title": { uz: "📖 Sessiya hikoyasi", ru: "📖 История сессии", en: "📖 Session story" },
  "story.hint": { uz: "Har agent nima qilgani — o'lchangan ma'lumotdan.", ru: "Что делал каждый агент — по измеренным данным.", en: "What each agent did — from measured data." },
  "story.worked": { uz: "ishladi", ru: "работал", en: "worked" },
  "story.turnsN": { uz: "navbat", ru: "очередей", en: "turns" },
  "story.toolsN": { uz: "tool", ru: "инстр.", en: "tools" },
  "story.mostly": { uz: "Asosan", ru: "В основном", en: "Mostly" },
  "story.subHired": { uz: "sub-agent yolladi", ru: "нанял саб-агентов", en: "sub-agents hired" },
  "story.blockedNow": { uz: "Hozir bloklangan", ru: "Сейчас заблокирован", en: "Blocked now" },
  "story.cacheSaved": { uz: "kesh tejadi", ru: "сэкономил кэш", en: "saved by cache" },
  "story.quietOne": { uz: "hali sezilarli ish yo'q", ru: "пока заметной работы нет", en: "no notable work yet" },
  "story.cat.edit": { uz: "fayl tahrirlash", ru: "правка файлов", en: "editing files" },
  "story.cat.read": { uz: "o'qish/qidirish", ru: "чтение/поиск", en: "reading/searching" },
  "story.cat.test": { uz: "test", ru: "тесты", en: "testing" },
  "story.cat.run": { uz: "buyruq", ru: "команды", en: "running commands" },
  "story.cat.research": { uz: "tadqiqot", ru: "исследование", en: "research" },
  "story.cat.other": { uz: "boshqa", ru: "прочее", en: "other" },
  // Surat / klip eksporti
